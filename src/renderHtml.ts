...
// ⚡ Bolt: Using a switch statement inside the replace callback performs faster than an
// object dictionary lookup in V8, avoiding object property access overhead.
